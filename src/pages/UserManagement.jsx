        ...
        {isLoading ? (
          ...
          <div className="space-y-2">
            ...
            {filteredUsers.map((user) => {
              ...
              const ROLE_LABELS = { admin: "Admin", hr_admin: "Admin HR", group_leader: "Group Leader", team_leader: "Team Leader", advisor: "Doradca", test_user: "Testowy", serviceman: "Serwisant", auditor: "Audytor", user: "Użytkownik" };
              const ROLE_COLORS = { admin: "bg-purple-100 text-purple-700", hr_admin: "bg-pink-100 text-pink-700", group_leader: "bg-blue-100 text-blue-700", team_leader: "bg-green-100 text-green-700", advisor: "bg-gray-100 text-gray-700", test_user: "bg-yellow-100 text-yellow-700", serviceman: "bg-orange-100 text-orange-700", auditor: "bg-teal-100 text-teal-700", user: "bg-gray-100 text-gray-700" };
              return (
            <div
              key={user.id}
